...
std::vector<float> Model::getFloats(json accessor) {
    ...
    json buffView = JSON["bufferViews"][buffViewIndex];
    unsigned int byteOffset = buffView.value("byteOffset", 0);
    ...
    if(type=="SCALAR") {
        ...
        throw std::invalid_argument("Unsupported type in accessor: " + type);
    }
